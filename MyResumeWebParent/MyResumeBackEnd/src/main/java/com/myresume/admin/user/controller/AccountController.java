...
public class AccountController {
    ...
    @GetMapping("/account")
    public String viewDetails(@AuthenticationPrincipal MyResumeUserDetails loggedUser,
                              Model model){
    ...
    public String saveDetails(User user, RedirectAttributes redirectAttributes,
                           @AuthenticationPrincipal MyResumeUserDetails loggedUser,
        ...
        redirectAttributes.addFlashAttribute("message","The account details data has been saved successfully");
